...
namespace Freya
{
	...
	public static class MathfsExtensions
	{
		...
		/// <inheritdoc cref="Mathfs.Clamp(int,int,int)"/>
		[MethodImpl(INLINE)]
		public static int Clamp01(this int value) => Mathfs.Clamp(value, 0, 1);
		...
		[MethodImpl(INLINE)]
		public static float Round(this float value) => Mathfs.Round(value);

		/// <inheritdoc cref="Mathfs.Round(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector2 Round(this Vector2 value) => Mathfs.Round(value);

		/// <inheritdoc cref="Mathfs.Round(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector3 Round(this Vector3 value) => Mathfs.Round(value);

		/// <inheritdoc cref="Mathfs.Round(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector4 Round(this Vector4 value) => Mathfs.Round(value);

		/// <inheritdoc cref="Mathfs.Round(float)"/>
		[MethodImpl(INLINE)]
		public static float Round(this float value, float snapInterval) => Mathfs.Round(value, snapInterval);

		/// <inheritdoc cref="Mathfs.Round(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector2 Round(this Vector2 value, float snapInterval) => Mathfs.Round(value, snapInterval);

		/// <inheritdoc cref="Mathfs.Round(Vector2,float)"/>
		[MethodImpl(INLINE)]
		public static Vector3 Round(this Vector3 value, float snapInterval) => Mathfs.Round(value, snapInterval);

		/// <inheritdoc cref="Mathfs.Round(Vector2,float)"/>
		[MethodImpl(INLINE)]
		public static Vector4 Round(this Vector4 value, float snapInterval) => Mathfs.Round(value, snapInterval);

		/// <inheritdoc cref="Mathfs.RoundToInt(float)"/>
		[MethodImpl(INLINE)]
		public static int RoundToInt(this float value) => Mathfs.RoundToInt(value);

		/// <inheritdoc cref="Mathfs.RoundToInt(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector2Int RoundToInt(this Vector2 value) => Mathfs.RoundToInt(value);

		/// <inheritdoc cref="Mathfs.RoundToInt(Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector3Int RoundToInt(this Vector3 value) => Mathfs.RoundToInt(value);
		...
		[MethodImpl(INLINE)]
		public static float Remap(this int value, float iMin, float iMax, float oMin, float oMax) => Mathfs.Lerp(oMin, oMax, Mathfs.InverseLerp(iMin, iMax, value));
		...
		/// <inheritdoc cref="Mathfs.Remap(float,float,float,float,float)"/>
		[MethodImpl(INLINE)]
		public static float RemapClamped(this float value, float iMin, float iMax, float oMin, float oMax) => Mathfs.Lerp(oMin, oMax, Mathfs.InverseLerpClamped(iMin, iMax, value));

		/// <inheritdoc cref="Mathfs.Remap(Vector2,Vector2,Vector2,Vector2,Vector2)"/>
		[MethodImpl(INLINE)]
		public static Vector2 Remap(this Vector2 value, int iMin, int iMax, int oMin, int oMax)
		{
			value.x = value.x.Remap(iMin, iMax, oMin, oMax);
			value.y = value.y.Remap(iMin, iMax, oMin, oMax);
			return value;
		}

		/// <inheritdoc cref="Mathfs.Remap(Vector3,Vector3,Vector3,Vector3,Vector3)"/>
		[MethodImpl(INLINE)]
		public static Vector3 Remap(this Vector3 value, int iMin, int iMax, int oMin, int oMax)
		{
			value.x = value.x.Remap(iMin, iMax, oMin, oMax);
			value.y = value.y.Remap(iMin, iMax, oMin, oMax);
			value.z = value.z.Remap(iMin, iMax, oMin, oMax);
			return value;
		}

		/// <inheritdoc cref="Mathfs.Remap(Vector4,Vector4,Vector4,Vector4,Vector4)"/>
		[MethodImpl(INLINE)]
		public static Vector4 Remap(this Vector4 value, int iMin, int iMax, int oMin, int oMax)
		{
			value.x = value.x.Remap(iMin, iMax, oMin, oMax);
			value.y = value.y.Remap(iMin, iMax, oMin, oMax);
			value.z = value.z.Remap(iMin, iMax, oMin, oMax);
			value.w = value.w.Remap(iMin, iMax, oMin, oMax);
			return value;
		}
