...
public static class VectorExtensions
{
	...
	public static Vector2 ClampMagnitude(this Vector2 vec2, float mag) => Vector2.ClampMagnitude(vec2, mag);
	public static Vector3 ClampMagnitude(this Vector3 vec3, float mag) => Vector3.ClampMagnitude(vec3, mag);
}