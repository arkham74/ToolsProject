...
namespace Crosstales.TPB.Util
{
	...
	public abstract class Helper : Crosstales.Common.EditorUtil.BaseEditorHelper
	{
		...
		public static Texture2D Logo_Asset => EditorGUIUtility.IconContent("SettingsIcon").image as Texture2D;

		public static Texture2D Logo_Asset_Small => EditorGUIUtility.IconContent("SettingsIcon").image as Texture2D;

		public static Texture2D Icon_Play => EditorGUIUtility.IconContent("Animation.Play").image as Texture2D;

		public static Texture2D Icon_Show => EditorGUIUtility.IconContent("animationvisibilitytoggleon").image as Texture2D;

		public static Texture2D Logo_Windows => EditorGUIUtility.IconContent("BuildSettings.Standalone").image as Texture2D;

		public static Texture2D Logo_Mac => EditorGUIUtility.IconContent("BuildSettings.Standalone").image as Texture2D;

		public static Texture2D Logo_Linux => EditorGUIUtility.IconContent("BuildSettings.EmbeddedLinux").image as Texture2D;

		public static Texture2D Logo_Ios => EditorGUIUtility.IconContent("BuildSettings.iPhone").image as Texture2D;

		public static Texture2D Logo_Android => EditorGUIUtility.IconContent("BuildSettings.Android").image as Texture2D;

		public static Texture2D Logo_Wsa => EditorGUIUtility.IconContent("BuildSettings.WP8").image as Texture2D;

		public static Texture2D Logo_Webgl => EditorGUIUtility.IconContent("BuildSettings.WebGL").image as Texture2D;

		public static Texture2D Logo_Tvos => EditorGUIUtility.IconContent("BuildSettings.tvOS").image as Texture2D;

		public static Texture2D Logo_Ps4 => EditorGUIUtility.IconContent("BuildSettings.PS4").image as Texture2D;

		public static Texture2D Logo_Xboxone => EditorGUIUtility.IconContent("BuildSettings.XboxOne").image as Texture2D;

		public static Texture2D Logo_Switch => EditorGUIUtility.IconContent("BuildSettings.Switch").image as Texture2D;
		...
		*/
		...
		public static bool hasBuild => System.IO.Directory.Exists(Config.PATH_BUILD);
