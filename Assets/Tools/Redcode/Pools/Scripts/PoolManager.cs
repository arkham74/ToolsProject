...
namespace Redcode.Pools
{
	...
	public class PoolManager : MonoBehaviour
	{
		...
		public void ReleaseToPool(int index, Component component) => _poolsObjects[index].Release(component);
		...
		/// <param name="component">Object (its component) which returns back.</param>
		public void ReleaseToPool<T>(Component component) where T : Component => GetPool<T>().Release(component);
		...
		/// <param name="name"><inheritdoc cref="GetPool{T}(string)"/></param>
		/// <param name="component">Object (its component) which returns back.</param>
		public void ReleaseToPool<T>(string name, Component component) where T : Component => GetPool<T>(name).Release(component);
		#endregion
	}
}
