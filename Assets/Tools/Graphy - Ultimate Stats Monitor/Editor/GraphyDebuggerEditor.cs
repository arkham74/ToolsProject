...
namespace Tayx.Graphy
{
	...
	internal class GraphyDebuggerEditor : Editor
	{
		...
		private string GetComparerStringFromDebugVariable(GraphyDebugger.DebugVariable debugVariable)
		{
			...
			{
				GraphyDebugger.DebugVariable.Fps => "FPS Current",
				GraphyDebugger.DebugVariable.Fps_Min => "FPS Min",
				GraphyDebugger.DebugVariable.Fps_Max => "FPS Max",
				GraphyDebugger.DebugVariable.Fps_Avg => "FPS Avg",
				GraphyDebugger.DebugVariable.Ram_Allocated => "Ram Allocated",
				GraphyDebugger.DebugVariable.Ram_Reserved => "Ram Reserved",
				GraphyDebugger.DebugVariable.Ram_Mono => "Ram Mono",
				GraphyDebugger.DebugVariable.Audio_DB => "Audio DB",
				_ => null,
			};
		}
		...
		{
			return debugComparer switch
			{
				GraphyDebugger.DebugComparer.Less_than => "<",
				GraphyDebugger.DebugComparer.Equals_or_less_than => "<=",
				GraphyDebugger.DebugComparer.Equals => "==",
				GraphyDebugger.DebugComparer.Equals_or_greater_than => ">=",
				GraphyDebugger.DebugComparer.Greater_than => ">",
				_ => null,
			};
		}
