...
namespace IngameDebugConsole
{
	...
	public static class DebugLogConsole
	{
		...
		{
			bool result = uint.TryParse(input, out uint value);
		...
		{
			bool result = byte.TryParse(input, out byte value);
		...
		{
			bool result = sbyte.TryParse(input, out sbyte value);
		...
		{
			bool result = short.TryParse(input, out short value);
		...
		{
			bool result = ushort.TryParse(input, out ushort value);
		...
		{
			bool result = char.TryParse(input, out char value);
