...
namespace Crosstales.Common.Util
{
	...
	public abstract class CTEditorPrefs
	{
		...
		*/
		...
		{
			return !string.IsNullOrEmpty(key) && EditorPrefs.HasKey(key);
		...
		/// <param name="key">Key to delete in the EditorPrefs.</param>
		...
		/// <param name="key">Key for the EditorPrefs.</param>
		/// <param name="value">Value for the EditorPrefs.</param>
		...
		/// <param name="key">Key for the EditorPrefs.</param>
		/// <param name="language">Value for the EditorPrefs.</param>
